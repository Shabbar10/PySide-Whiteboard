...
class Ui_MainWindow(object):
    def setupUi(self, MainWindow):
        ...
        icon = QIcon()
        icon.addFile(u":/Tools/line.png", QSize(), QIcon.Mode.Normal, QIcon.State.Off)
        self.pb_Line.setIcon(icon)
...
"")
        ...
        icon2 = QIcon()
        icon2.addFile(u":/Tools/redo.png", QSize(), QIcon.Mode.Normal, QIcon.State.Off)
        ...
        icon4 = QIcon()
        icon4.addFile(u":/Tools/pen.png", QSize(), QIcon.Mode.Normal, QIcon.State.Off)
        self.pb_Pen.setIcon(icon4)
