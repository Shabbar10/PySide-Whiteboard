...
class Ui_MainWindow(object):
    def setupUi(self, MainWindow):
        ...
        icon = QIcon()
        icon.addFile(u":/Tools/rect.png", QSize(), QIcon.Mode.Normal, QIcon.State.Off)
        self.pb_Rectangle.setIcon(icon)
        ...
        icon5 = QIcon()
        icon5.addFile(u":/Tools/ellipse.png", QSize(), QIcon.Mode.Normal, QIcon.State.Off)
