...
"")
        ...
        self.gridLayout.addWidget(self.gv_Canvas, 0, 1, 12, 1)

        self.pb_Rectangle = QPushButton(self.centralwidget)
        self.pb_Rectangle.setObjectName(u"pb_Rectangle")
        icon1 = QIcon()
        icon1.addFile(u":/Tools/rect.png", QSize(), QIcon.Mode.Normal, QIcon.State.Off)
        self.pb_Rectangle.setIcon(icon1)
        ...
        icon2 = QIcon()
        icon2.addFile(u":/Tools/undo.png", QSize(), QIcon.Mode.Normal, QIcon.State.Off)
        self.pb_Undo.setIcon(icon2)
        self.pb_Undo.setCheckable(False)

        self.gridLayout.addWidget(self.pb_Undo, 10, 0, 1, 1)
        ...
        icon3 = QIcon()
        icon3.addFile(u":/Tools/ellipse.png", QSize(), QIcon.Mode.Normal, QIcon.State.Off)
        self.pb_Ellipse.setIcon(icon3)
        ...
        icon4 = QIcon()
        icon4.addFile(u":/Tools/redo.png", QSize(), QIcon.Mode.Normal, QIcon.State.Off)
        self.pb_Redo.setIcon(icon4)
        self.pb_Redo.setCheckable(False)

        self.gridLayout.addWidget(self.pb_Redo, 11, 0, 1, 1)
        ...
        icon5 = QIcon()
        icon5.addFile(u":/Tools/eraser.png", QSize(), QIcon.Mode.Normal, QIcon.State.Off)
        self.pb_Eraser.setIcon(icon5)
        ...
        icon6 = QIcon()
        icon6.addFile(u":/Tools/line.png", QSize(), QIcon.Mode.Normal, QIcon.State.Off)
        self.pb_Line.setIcon(icon6)
        self.pb_Line.setCheckable(True)

        self.gridLayout.addWidget(self.pb_Line, 2, 0, 1, 1)

        self.pb_HW2T = QPushButton(self.centralwidget)
        self.pb_HW2T.setObjectName(u"pb_HW2T")

        self.gridLayout.addWidget(self.pb_HW2T, 5, 0, 1, 1)
    ...
    def retranslateUi(self, MainWindow):
        ...
        self.pb_HW2T.setText(QCoreApplication.translate("MainWindow", u"HW2T", None))
