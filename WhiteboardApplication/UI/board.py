...
from Whiteboard import Icons_rc
...
class Ui_MainWindow(object):
    def setupUi(self, MainWindow):
        ...
        self.pb_line.setObjectName(u"pb_Shapes")
        icon2 = QIcon()
        icon2.addFile(u":/Tools/line.png", QSize(), QIcon.Normal, QIcon.Off)
        self.pb_line.setIcon(icon2)
        ...
        self.pb_ellipse.setObjectName(u"pb_eclipse")
        self.pb_ellipse.setCheckable(True)

        self.gridLayout.addWidget(self.pb_ellipse, 1, 0, 3, 1)

        # rectangle
        self.pb_rectangle = QPushButton(self.centralwidget)
        self.pb_rectangle.setObjectName(u"pb_rect")
        self.pb_rectangle.setCheckable(True)

        self.gridLayout.addWidget(self.pb_rectangle, 5, 0, 1, 1)
        ...
        # menu for connect
        self.menuConnect = self.menubar.addMenu(u"Connect")
        self.menu_User = QMenu(self.menuConnect)
        self.menu_User.setObjectName(u"menu_User")

        self.menuConnect.addAction(self.menu_User.menuAction())
        self.menu_User.addAction(self.actionUser)
    ...
    def retranslateUi(self, MainWindow):
        ...
        self.actionCoolDude.setText(QCoreApplication.translate("MainWindow", u"New Board", None))
        self.actionClose_2.setText(QCoreApplication.translate("MainWindow", u"Close", None))
        self.actionUser.setText((QCoreApplication.translate("MainWindow", u"User Count", None)))
        ...
        self.menu_User.setTitle(QCoreApplication.translate("MainWindow", u"Active Users", None))
    # retranslateUi
